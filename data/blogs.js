/* ============================================================
   ...
   3. Photos come from the "image" field. Paste any image URL,
      or download one into images/ and use "images/my-photo.jpg".
   4. Save + commit. The newest post should go at the TOP.

   Photos below are from Unsplash (free to use, no attribution
   required). Swap any URL for your own whenever you like.
   ============================================================ */
...
During deep sleep the body produces and redistributes infection-fighting cells and clears waste from the brain. Cut sleep short for even a few nights and markers of inflammation rise while vaccine responses weaken.

What actually helps, a consistent wake-up time even on weekends, morning daylight within an hour of waking, a cool dark room, a screen curfew about 45 minutes before bed, and caffeine kept to the morning.
...
You don't need a perfect eight hours. Aim for a regular window and protect it like an appointment.`
  },
  {
    ...
    date: "Jun 29, 2026",
    summary: "Short walks after meals blunt blood-sugar spikes.",
...
A short walk after eating helps muscles pull glucose out of the bloodstream, which softens the post-meal spike linked to fatigue and long-term strain. Standing up and moving once an hour also counters the stiffness and circulation dips of long sitting.
...
Pair it with slightly larger text, a screen at arm's length just below eye level, and lubricating drops if you run dry. If blur or pain persists, that's worth a check with an optometrist.`
  },
  {
    ...
    date: "Jun 21, 2026",
    summary: "Diversity of plants, not any single superfood, feeds a healthy gut.",
...
You don't need to overhaul your diet. Swap in a new vegetable, add beans to a dish you already make, and treat the spice rack as free points.`
  },
  {
    ...
    icon: "🌬️",
    body:
`When stress spikes, breathing offers a rare direct dial on the nervous system. The trick is the exhale, making your out-breath longer than your in-breath nudges the calming "rest and digest" side into action, slowing heart rate within a minute or two.
